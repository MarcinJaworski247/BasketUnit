        ...
        <div class="printers">
            ...
            <DxDataGrid
                ...
                <div slot="actionsCellTemplate" slot-scope="{ data }">
                    <DxButton @click="showEditPopupMethod(data)" hint="Edytuj" title="Edytuj" icon="fas fa-pen" class="datagrid-button" type="normal" />
                    <DxButton @click="showDeletePopupMethod(data)" hint="Usuń" title="Usuń" icon="fas fa-trash" class="ml-3 datagrid-button" type="normal" />
                </div>
            </DxDataGrid>
